...
test("bundle, offline install, receipt, discovery, integrity, and repair form a clean-room closure", async (t) => {
  ...
  assert.equal(manifest.runtime.version, "0.1.1-rc.6");
  ...
  assert.equal(receipt.runtime_version, "0.1.1-rc.6");
  ...
  assert.match((await run(process.execPath, [cli, "--version"], root)).stdout, /0\.1\.1-rc\.6/);
  ...
  assert.equal(discovered.runtime_version, "0.1.1-rc.6");
