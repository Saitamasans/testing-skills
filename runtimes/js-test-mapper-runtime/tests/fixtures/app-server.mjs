...
export async function startDcatReadonlyFixture() {
  ...
  const server = createServer((request, response) => {
    ...
    const shell = (content, title) => "<!doctype html><html><head><title>" + title + "</title><script src=\"/assets/admin.js\"></script></head><body>" +
      "<aside class=\"main-sidebar\"><nav class=\"mt-2\"><ul class=\"nav nav-pills nav-sidebar flex-column\" data-widget=\"treeview\"><li><a class=\"nav-link\" href=\"/admin/dashboard\">Dashboard</a></li><li><a class=\"nav-link\" href=\"/admin/safe-a\">Safe menu A</a></li><li><a class=\"nav-link\" href=\"/admin/broken\">Broken menu</a></li><li><a class=\"nav-link\" href=\"/admin/safe-b\">Safe menu B</a></li><li><a class=\"nav-link\" href=\"/admin/orders\">Orders</a><ul class=\"nav nav-treeview\"><li><a class=\"nav-link\" href=\"/admin/orders\">Order List</a></li><li><a class=\"nav-link\" href=\"/admin/settings\">Settings</a></li></ul></li><li><a class=\"nav-link\" href=\"/admin/orders/create\">Create Order</a></li><li><a class=\"nav-link\" href=\"/admin/cache/clear\">Clear Cache</a></li><li><a class=\"nav-link\" href=\"/admin/password/reset\">Reset Password</a></li><li><a class=\"nav-link\" data-url=\"/admin/data/sync\" href=\"/admin/data/sync\">Sync Data</a></li><li><a class=\"nav-link\" href=\"/admin/refund\">Refund</a></li><li><a class=\"nav-link\" href=\"/admin/orders/cancel\">Cancel Order</a></li><li><a class=\"nav-link\" href=\"/admin/regenerate\">Regenerate</a></li><li><a class=\"nav-link\" href=\"/admin/tasks/run\">Run Task</a></li><li><a class=\"nav-link\" href=\"/admin/orders/export\">Export</a></li></ul></nav></aside>" +
