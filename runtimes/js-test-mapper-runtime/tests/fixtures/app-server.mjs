...
export async function startDcatReadonlyFixture() {
  ...
  const server = createServer((request, response) => {
    ...
    if (pathname === "/admin/dashboard") return send(shell("<h1>Dashboard</h1><p>Overview</p><script>setTimeout(() => { const a=document.createElement(\"a\"); a.href=\"/admin/delayed\"; a.textContent=\"Delayed Report\"; document.querySelector(\"main\").append(a); }, 320);</script>", "Dashboard"));
