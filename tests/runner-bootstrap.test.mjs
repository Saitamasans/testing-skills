...
function manifest(overrides = {}) {
  return {
    ...
    runner: {
      ...
      version: "1.0.3",
      download_url: "https://github.com/Saitamasans/testing-skills/releases/download/testing-runner-v1.0.3/saitamasans-testing-runner-1.0.3.tgz",
...
test("validates only the fixed project GitHub Release", () => {
  assert.equal(validateReleaseManifest(manifest()).runner.version, "1.0.3");
  assert.throws(
