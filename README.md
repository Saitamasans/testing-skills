...
| Web JS测试系统建图<br>`js-test-mapper` | 在已授权测试环境中，借助 Codex 已有浏览器能力做只读 JS 证据分析，恢复 Route、代表调用链、接口引用、权限和状态线索。 | [![Install](https://img.shields.io/badge/Install_RC-2ea44f)](https://github.com/Saitamasans/testing-skills/releases/download/v0.2.0/install-js-test-mapper.cmd) |
