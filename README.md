...
| 无需求-Web JS逆向测试建图<br>`js-test-mapper` | 只有 Web Test URL 或需求资料不完整时，借助 Codex 已有浏览器能力做只读 JS 证据分析，恢复 Route、代表调用链、接口引用、权限和状态线索。 | [![Install](https://img.shields.io/badge/Install_RC-2ea44f)](https://raw.githubusercontent.com/Saitamasans/testing-skills/main/installers/install-js-test-mapper.cmd) |
