...
| 无需求-Web JS逆向测试建图<br>`js-test-mapper` | 只有 Web Test URL 或需求资料不完整时，用只读 JS / Runtime 逆向恢复 Route、代表调用链、接口引用、权限和状态线索。 | [![Install](https://img.shields.io/badge/Install_RC-2ea44f)](https://github.com/Saitamasans/testing-skills/releases/download/v0.1.1-rc.3/install-js-test-mapper.cmd) |
